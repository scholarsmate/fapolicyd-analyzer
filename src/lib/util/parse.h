...
/**
 * @brief Imbues the parser with the fields, order of fields and number of fields to parse and allocates internal data structures for parsing
 * 
 * @param parse_ctx a constructed parse_context pointer
 * @param line null-terminated line containing an exemplar record to imbue into the parser context
