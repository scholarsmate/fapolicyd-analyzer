...
static void _sha256_transform(sha256_ctx_t *ctx, const unsigned char *data) {
...
sha256_ctx_t *sha256_create(void) {
  sha256_ctx_t *ctx = malloc(sizeof(sha256_ctx_t));
  if (ctx) {
    ctx->datalen = 0;
    ctx->bitlen = 0;
